...
jQuery(window).load(function () {
    'use strict';
    /* Isotope */
    jQuery('.baganuur-ut-isotope-container').each(function (i) {
        var $currentIsotopeArea = jQuery(this);
        var $currentInfinite = $currentIsotopeArea.children(
            '.baganuur-ut-infinite-scroll'
        );
        var $currentIsotopeContainer =
            $currentIsotopeArea.children('.isotope-container');
        var $currentFilter = $currentIsotopeArea.find('ul.filters');
        var $currentFilterYear = $currentIsotopeArea.find('.filter-year');
        var $currentFilterYearLi = $currentFilterYear.find('li');
        showIsotopeFilter(
            $currentFilter,
            $currentIsotopeContainer.children('article')
        );
        ...
        $currentInfinite
            ...
            .bind('click', function (e) {
                ...
                if (
                    $currentInfinite.attr('data-has-next') === 'true' &&
                    $currentNextLink.hasClass('next')
                ) {
                    ...
                    jQuery.ajax({
                        ...
                        success: function (response) {
                            var $newElements = jQuery(response)
                                .find('.baganuur-ut-isotope-container')
                                .eq(i)
                                .children('.isotope-container')
                                .html();
                            var $newElementsObj = jQuery(response)
                                .find('.baganuur-ut-isotope-container')
                                .eq(i)
                                .children('.isotope-container');
                            var $newURL = jQuery(response)
                                .find('.baganuur-ut-isotope-container')
                                .eq(i)
                                .find('.baganuur-ut-infinite-scroll>a.next')
                                .attr('href');
                            var $hasNext = jQuery(response)
                                .find('.baganuur-ut-isotope-container')
                                .eq(i)
                                .find('.baganuur-ut-infinite-scroll')
                                .attr('data-has-next');
                            if ($newElements) {
                                $currentIsotopeContainer.append($newElements);
                                if ($hasNext === 'false') {
                                    $currentInfinite.attr(
                                        'data-has-next',
                                        'false'
                                    );
                                    $currentInfinite
                            ...
                            $currentIsotopeContainer
                                .find('img')
                                .unbind('load')
                                .bind('load', function () {
                                    baganuurReInit(jQuery('#baganuur-ut-main'));
                                    baganuur_button_init(
                                        jQuery('#baganuur-ut-main')
                                    );
                                    $currentIsotopeContainer
                                        .isotope('reloadItems')
        ...
        $currentFilterYearLi.each(function () {
            var $YearFilterText = jQuery(this).text();
            var $YearFilterA = jQuery(this).find('a');
            $YearFilterA.attr('href', '#filter');
            if ($YearFilterA.hasClass('show-all')) {
                $YearFilterA.attr('data-option-value', '*');
            } else {
                $YearFilterA.attr(
                    'data-option-value',
                    '.filter-year-' + $YearFilterText
                );
            }
            $YearFilterA.addClass('filter-buttons');
        });
        /* Filter */
        $currentFilter.each(function () {
            var filters = {};
            $currentFilter.on('click', 'li', function () {
                var $this = jQuery(this).find('.filter-buttons');
                var $buttonGroup = $this.parents().parents('.filters');
                var filterGroup = $buttonGroup.attr('data-option-key');
                ...
                $currentIsotopeContainer.isotope({ filter: filterValue });
            });
        });
    ...
    baganuurReInit(jQuery('.baganuur-ut-isotope-container'));
});
    ...
    $currnetElements.each(function () {
        ...
        if ($currentFilter.html()) {
            $currentFilter.children('li.hidden').each(function () {
                var $currentFilterClass = jQuery(this)
                    .children('a')
                    .attr('data-option-value')
                    .replace('.', '');
                if ($currnetElement.hasClass($currentFilterClass)) {
    ...
    $currentIsotopeContainer
        ...
        .each(function (i) {
            ...
            var $curr = jQuery(this)
                ...
                .find('.baganuur-ut-animate-gen,.baganuur-ut-animate');
        ...
        .done(function () {
            if (
                jQuery('.wp-video-shortcode').length ||
                jQuery('.wp-audio-shortcode').length
            ) {
